...
- [x] **Topic 8 — Editor mode vs. plain GitHub.** **[DECIDED 2026-05-03]** Closed by [ADR 0002](adrs/0002-repo-topology-and-editor-onboarding.md). Editor mode is a real persona with concrete cantilever steps (gh auth, repo clone, VS Code + CriticMarkup install, auto-sync VS Code task). Daily flow is zero-command via Cmd+S → debounced `ergodix sync`.
