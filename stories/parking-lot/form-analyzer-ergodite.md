...
- [ ] Pull rhetoric primitives from [devils-toolbox](devils-toolbox.md) once that ships; until then, inline a minimal definition table inside the form-analyzer module.
...
- [devils-toolbox](devils-toolbox.md): rhetoric primitives.
