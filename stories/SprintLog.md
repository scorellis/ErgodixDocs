...
- [ ] Pull rhetoric primitives from Devil's Toolbox once that ships; until then, inline a minimal definition table inside the form-analyzer module.
- [ ] Cross-reference: [Spike 0014 — form-analyzer ergodite](spikes/0014-form-analyzer-ergodite.md) (design).
- [ ] Cross-reference: [Spike 0013](spikes/0013-style-sentinel-and-certificate.md) (registry contract); [Spike 0010](spikes/0010-user-writing-preferences-interview.md) (target band + Fibonacci preferences); [Devil's Toolbox story](#story--devils-toolbox-foundational-rhetoric-reference-skill-sprint-2-when-activated) (rhetoric primitives).
